    ...
    <div style={s.page}>
      <style>{`
        @media (max-width: 768px) {
          ...
          .comparison-table-wrapper table { min-width: 600px; }
        }
      `}</style>
      <div style={s.container}>
        ...
        {/* Part selector */}
        <div className="comparison-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px', marginBottom: '32px' }}>
