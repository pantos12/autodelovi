    ...
    <div style={s.page}>
      <style>{`
        @media (max-width: 768px) {
          .compare-selector-grid { grid-template-columns: 1fr !important; }
      ...
      <div style={s.container}>
        ...
        {/* Part selector */}
        <div className="compare-selector-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px', marginBottom: '32px' }}>
