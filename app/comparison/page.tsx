    ...
    <div style={s.page}>
      <style>{`
        @media (max-width: 768px) {
          .cmp-slots { grid-template-columns: 1fr !important; }
      ...
      <div style={s.container}>
        ...
        {/* Part selector */}
        <div className="cmp-slots" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px', marginBottom: '32px' }}>
        ...
        {/* Comparison table */}
        {parts.length > 0 && (
          <div className="cmp-table-wrap" style={{ background: '#1a1b1f', borderRadius: '12px', overflow: 'hidden', border: '1px solid #252629' }}>
