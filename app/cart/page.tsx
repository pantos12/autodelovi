      ...
      <div style={{ maxWidth: '1100px', margin: '0 auto', padding: '32px 16px' }}>
        ...
        <div className="cart-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 360px', gap: '24px', alignItems: 'start' }}>
          ...
          <div className="cart-summary" style={{ background: '#1a1b1f', borderRadius: '12px', padding: '20px', border: '1px solid #2a2b2f', position: 'sticky', top: '80px' }}>
            ...
            {shipping > 0 && (
              <div style={{ marginBottom: '16px', padding: '12px', background: '#0c0d0f', borderRadius: '8px' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '6px' }}>
                  ...
                  <span style={{ color: '#f9372c', fontSize: '12px', fontWeight: 600 }}>
            ...
            {shipping > 0 && (
              <p style={{ color: '#888', fontSize: '11px', textAlign: 'right', marginBottom: '4px' }}>
                Besplatna dostava za porudžbine preko {freeShippingThreshold.toLocaleString('sr-RS')} RSD
              </p>
            )}
