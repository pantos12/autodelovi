          ...
          <div className="cart-summary" style={{ background: '#1a1b1f', borderRadius: '12px', padding: '20px', border: '1px solid #2a2b2f', position: 'sticky', top: '80px' }}>
            ...
            {shipping > 0 && (
              <div style={{ marginBottom: '10px' }}>
                <div style={{ background: '#252629', borderRadius: '4px', height: '6px', overflow: 'hidden', marginBottom: '4px' }}>
                  <div style={{ background: '#f9372c', height: '100%', borderRadius: '4px', width: `${Math.min(100, (subtotal / freeShippingThreshold) * 100)}%`, transition: 'width 0.3s' }} />
                </div>
