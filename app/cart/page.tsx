            ...
            {shipping > 0 && (
              <div style={{ marginBottom: '14px' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '6px' }}>
                  ...
                  <span style={{ color: '#888', fontSize: '12px' }}>{(freeShippingThreshold - subtotal).toLocaleString('sr-RS')} RSD</span>
                </div>
                <div style={{ width: '100%', height: '4px', background: '#252629', borderRadius: '2px', overflow: 'hidden' }}>
                  <div style={{ width: `${Math.min(100, (subtotal / freeShippingThreshold) * 100)}%`, height: '100%', background: '#f9372c', borderRadius: '2px', transition: 'width 0.3s' }} />
                </div>
              </div>
            )}
