        ...
        <div className="nav-desktop" style={{ display: 'flex', alignItems: 'center', gap: '12px', flexShrink: 0 }}>
          {user ? (
            <div style={{ position: 'relative' }} data-user-menu>
              ...
              {userMenuOpen && (
                <div role="menu" style={{ position: 'absolute', top: '42px', right: 0, background: '#1a1b1f', border: '1px solid #333', borderRadius: '8px', padding: '8px 0', minWidth: '180px', zIndex: 200 }}>
