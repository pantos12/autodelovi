...
export default function HomeClient() {
  ...
  return (
    <>
      ...
      <div style={{ background: '#0c0d0f', color: '#fff', fontFamily: "'Inter','Helvetica Neue',sans-serif", position: 'relative', overflow: 'hidden' }}>
        ...
        {/* HERO */}
        <section className="hero-pad" style={{ position: 'relative', zIndex: 5, maxWidth: '900px', margin: '0 auto', padding: '80px 24px 60px' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '48px', flexWrap: 'wrap' }}>
            {[
              ...
              <div key={stat.label} style={{ textAlign: 'center' }}>
                <div style={{ color: '#f9372c', fontSize: '28px', fontWeight: 800 }}>{stat.value}</div>
                <div style={{ color: 'rgba(255,255,255,0.4)', fontSize: '12px', letterSpacing: '1px', textTransform: 'uppercase', marginTop: '4px' }}>{stat.label}</div>
              </div>
            ))}
          </div>
        </section>
