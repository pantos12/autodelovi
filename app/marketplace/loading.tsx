    ...
    <div style={{ background: '#0c0d0f', minHeight: '100vh' }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '24px 16px', display: 'grid', gridTemplateColumns: '240px 1fr', gap: '24px' }}>
        ...
        <div style={{ background: '#1a1b1f', borderRadius: '12px', padding: '20px', height: '400px' }}>
          ...
          <div style={{ height: '36px', background: '#252629', borderRadius: '8px', marginBottom: '16px' }} />
          <div style={{ height: '14px', width: '70%', background: '#252629', borderRadius: '4px', marginBottom: '12px' }} />
          <div style={{ height: '36px', background: '#252629', borderRadius: '8px' }} />
        </div>
        {/* Grid skeleton */}
        <div>
          <div style={{ height: '14px', width: '120px', background: '#252629', borderRadius: '4px', marginBottom: '20px' }} />
