  ...
  return (
    <div style={{ background: '#0c0d0f', minHeight: '100vh' }}>
      <div className="marketplace-grid" style={{ maxWidth: '1200px', margin: '0 auto', padding: '24px 16px', display: 'grid', gridTemplateColumns: '240px 1fr', gap: '24px' }}>
        <div className="marketplace-sidebar" style={{ background: '#1a1b1f', borderRadius: '12px', padding: '20px', height: '400px' }}>
          <div style={{ height: '14px', width: '80px', background: '#252629', borderRadius: '4px', marginBottom: '16px' }} />
