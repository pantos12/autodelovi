    ...
    <div style={{ background: '#0c0d0f', minHeight: '100vh' }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '24px 16px', display: 'grid', gridTemplateColumns: '240px 1fr', gap: '24px' }}>
        <div style={{ background: '#1a1b1f', borderRadius: '12px', padding: '20px', height: '400px' }}>
          <div style={{ height: '14px', background: '#252629', borderRadius: '4px', marginBottom: '20px', width: '60%' }} />
          <div style={{ height: '40px', background: '#252629', borderRadius: '8px', marginBottom: '16px' }} />
          <div style={{ height: '14px', background: '#252629', borderRadius: '4px', marginBottom: '8px', width: '40%' }} />
          <div style={{ height: '40px', background: '#252629', borderRadius: '8px', marginBottom: '16px' }} />
          <div style={{ height: '14px', background: '#252629', borderRadius: '4px', marginBottom: '8px', width: '50%' }} />
          <div style={{ height: '40px', background: '#252629', borderRadius: '8px', marginBottom: '16px' }} />
        </div>
        <div>
          <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '20px' }}>
            <div style={{ height: '14px', background: '#252629', borderRadius: '4px', width: '120px' }} />
            <div style={{ height: '36px', background: '#252629', borderRadius: '8px', width: '160px' }} />
          </div>
