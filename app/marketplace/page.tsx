...
function MarketplaceContent() {
  ...
  const s = {
    ...
    container: { maxWidth: '1200px', margin: '0 auto', padding: '24px 16px', display: 'grid', gap: '24px' } as React.CSSProperties,
    ...
    card: { background: '#1a1b1f', borderRadius: '12px', overflow: 'hidden', animation: 'fadeIn 0.3s ease-out' } as React.CSSProperties,
  };
    ...
    <div style={s.page}>
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          .mp-products-grid { grid-template-columns: repeat(auto-fill, minmax(160px, 1fr)) !important; }
        }
      `}</style>
      <div className="mp-layout" style={s.container}>
        ...
        <div>
          ...
          {loading ? (
            <div className="mp-products-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(220px, 1fr))', gap: '16px' }}>
