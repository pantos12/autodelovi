...
function MarketplaceContent() {
  ...
  return (
    <div style={s.page}>
      <div className="responsive-grid-sidebar" style={s.container}>
        <div className="responsive-sidebar" style={s.sidebar}>
          ...
          {loading ? (
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(220px, 1fr))', gap: '16px' }}>
              {displayParts.map((part, idx) => {
                ...
                return (
                  <div key={part.id} className="card-hover" style={{ ...s.card, border: compareList.includes(part.id) ? '2px solid #ff4d00' : '2px solid transparent' }}>
