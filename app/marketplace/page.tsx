    ...
    <div style={s.page}>
      ...
      <div className="mp-container" style={s.container}>
        ...
        <button
          ...
          style={{ display: 'none', alignItems: 'center', justifyContent: 'center', gap: '8px', padding: '10px 16px', background: '#1a1b1f', border: '1px solid #333', borderRadius: '8px', color: '#fff', cursor: 'pointer', fontSize: '14px', fontWeight: 600, gridColumn: '1 / -1' }}
        >
          {mobileFilters ? '✕ Zatvori filtere' : '⚙ Filteri i pretraga'}
        </button>
        <div className={`mp-sidebar${mobileFilters ? ' mp-sidebar--open' : ''}`} style={s.sidebar}>
