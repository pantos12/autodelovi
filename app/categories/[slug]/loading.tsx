      ...
      <div style={{ background: 'linear-gradient(135deg, #1a1b1f 0%, #0c0d0f 100%)', padding: '48px 16px' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
            ...
            <div>
              <div style={{ height: '28px', background: '#252629', borderRadius: '6px', width: '160px', marginBottom: '8px' }} />
              <div style={{ height: '16px', background: '#252629', borderRadius: '4px', width: '200px' }} />
            </div>
          </div>
        </div>
      </div>
