...
export default function PartError({
  ...
  return (
    <div style={{ background: '#0c0d0f', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', gap: '16px', padding: '24px' }}>
      ...
      <h2 style={{ color: '#fff', fontSize: '20px', fontWeight: 700 }}>Greška pri učitavanju dela</h2>
      <p style={{ color: '#aaa', fontSize: '14px' }}>Ovaj deo nije pronađen ili je došlo do greške.</p>
      <div style={{ display: 'flex', gap: '12px' }}>
        ...
        <a href="/marketplace" style={{ padding: '12px 24px', background: '#333', borderRadius: '8px', color: '#fff', textDecoration: 'none', fontWeight: 600, fontSize: '14px' }}>
          Marketplace
        </a>
      </div>
    </div>
