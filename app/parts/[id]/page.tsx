    ...
    <div style={{ background: '#0c0d0f', minHeight: '100vh' }}>
      ...
      <style>{`
        @media (max-width: 768px) {
          ...
          .pdp-sidebar { position: static !important; }
          .pdp-breadcrumb { font-size: 12px !important; }
          .pdp-title { font-size: 22px !important; }
          .pdp-image { height: 240px !important; }
        }
      `}</style>
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '24px 16px' }}>
        ...
        <div className="pdp-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 360px', gap: '32px', alignItems: 'start' }}>
          ...
          <div>
            {/* Image */}
            <div className="pdp-image" style={{ position: 'relative', background: '#1a1b1f', borderRadius: '16px', height: '320px', marginBottom: '24px', border: '1px solid #252629', overflow: 'hidden' }}>
              <Image
            ...
            {/* Title */}
            <h1 className="pdp-title" style={{ color: '#fff', fontSize: '28px', fontWeight: 800, marginBottom: '8px' }}>{part.name_sr || part.name}</h1>
          ...
          {/* Right: Buy card */}
          <div className="pdp-sidebar" style={{ position: 'sticky', top: '80px' }}>
