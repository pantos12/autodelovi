    ...
    <div style={{ background: '#0c0d0f', minHeight: '100vh' }}>
      <style>{`
        @media (max-width: 768px) {
          ...
          .part-title { font-size: 22px !important; }
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '24px 16px' }}>
        {/* Breadcrumb */}
        <nav style={{ display: 'flex', gap: '8px', alignItems: 'center', marginBottom: '24px', fontSize: '14px', flexWrap: 'wrap' }}>
        ...
        <div className="part-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 360px', gap: '32px', alignItems: 'start' }}>
          {/* Left column */}
          <div>
            ...
            <h1 className="part-title" style={{ color: '#fff', fontSize: '28px', fontWeight: 800, marginBottom: '8px' }}>{part.name_sr || part.name}</h1>
          ...
          <div className="part-buy-card" style={{ position: 'sticky', top: '80px' }}>
            <div style={{ background: '#1a1b1f', borderRadius: '16px', padding: '24px', border: '1px solid #252629' }}>
              ...
              {part.price_eur && (
                <div style={{ color: '#aaa', fontSize: '14px', marginBottom: '8px' }}>&asymp; &euro;{part.price_eur.toFixed(2)}</div>
              )}
              ...
              {part.source_url && (
                <a href={part.source_url} target="_blank" rel="noopener noreferrer" style={{ display: 'block', textAlign: 'center', marginTop: '12px', color: '#aaa', fontSize: '12px', textDecoration: 'none' }}>
                  Pogledaj na sajtu dobavljača &rarr;
                </a>
              )}
            </div>
          </div>
        ...
        {related.length > 0 && (
          <div style={{ marginTop: '48px' }}>
            ...
            <div className="related-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(220px, 1fr))', gap: '16px' }}>
              {related.map((rp) => (
