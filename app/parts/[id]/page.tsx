...
export async function generateMetadata({ params }: { params: { id: string } }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      description: `${part.brand}${part.price ? ` - ${part.price.toLocaleString('sr-RS')} RSD` : ''}`,
    },
  };
}
                ...
                return (
                  <div key={rp.id} style={{ background: '#1a1b1f', borderRadius: '12px', overflow: 'hidden', border: '1px solid #252629' }}>
                    ...
                    <div style={{ padding: '12px' }}>
                      ...
                      <p style={{ color: '#ff4d00', fontSize: '16px', fontWeight: 700, marginBottom: '8px' }}>{rp.price != null ? `${rp.price.toLocaleString('sr-RS')} RSD` : 'Cena na upit'}</p>
