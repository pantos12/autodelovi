    ...
    <div style={{ background: '#0c0d0f', minHeight: '100vh' }}>
      <style>{`
        @media (max-width: 768px) {
          ...
          .pdp-breadcrumb { overflow-x: auto; white-space: nowrap; -webkit-overflow-scrolling: touch; }
        }
      `}</style>
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '24px 16px' }}>
        {/* Breadcrumb */}
        <div className="pdp-breadcrumb" style={{ display: 'flex', gap: '8px', alignItems: 'center', marginBottom: '24px', fontSize: '14px' }}>
