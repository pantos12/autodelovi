    ...
    <div style={{ background: '#0c0d0f', minHeight: '100vh' }}>
      ...
      <style>{`
        @media (max-width: 900px) {
          ...
          .part-breadcrumb { font-size: 12px !important; flex-wrap: wrap; }
        }
      `}</style>
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '24px 16px' }}>
        {/* Breadcrumb */}
        <nav className="part-breadcrumb" aria-label="Navigacija" style={{ display: 'flex', gap: '8px', alignItems: 'center', marginBottom: '24px', fontSize: '14px' }}>
          ...
          <span style={{ color: '#fff', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{part.name_sr || part.name}</span>
        </nav>
