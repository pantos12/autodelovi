    ...
    <div style={{ background: '#0c0d0f', minHeight: '100vh' }}>
      <style>{`
        @media (max-width: 900px) {
          ...
          .detail-buy-card { position: static !important; order: -1; }
        }
      `}</style>
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '24px 16px' }}>
        ...
        <div className="detail-layout" style={{ display: 'grid', gridTemplateColumns: '1fr 360px', gap: '32px', alignItems: 'start' }}>
          {/* Left column */}
          <div>
            {/* Image */}
          ...
          {/* Right: Buy card */}
          <div className="detail-buy-card" style={{ position: 'sticky', top: '80px' }}>
