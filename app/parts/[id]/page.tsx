...
export default async function PartDetail({ params }: { params: { id: string } }) {
  ...
  return (
    <div style={{ background: '#0c0d0f', minHeight: '100vh' }}>
      <style>{`
        .part-layout { grid-template-columns: 1fr 360px; }
        @media (max-width: 768px) {
          .part-layout { grid-template-columns: 1fr !important; }
          .part-buy-card { position: static !important; }
          .part-breadcrumb { overflow-x: auto; white-space: nowrap; }
          .part-image-box { height: 240px !important; }
        }
      `}</style>
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '24px 16px' }}>
        ...
        <div className="part-layout" style={{ display: 'grid', gridTemplateColumns: '1fr 360px', gap: '32px', alignItems: 'start' }}>
          ...
          <div>
            {/* Image */}
            <div className="part-image-box" style={{ position: 'relative', background: '#1a1b1f', borderRadius: '16px', height: '320px', marginBottom: '24px', border: '1px solid #252629', overflow: 'hidden' }}>
              <Image
