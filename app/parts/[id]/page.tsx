...
export default async function PartDetail({ params }: { params: { id: string } }) {
  ...
  const partJsonLd = {
    ...
    description: part.description_sr || part.description || `${part.name_sr || part.name} - auto deo`,
  ...
  return (
    <div style={{ background: '#0c0d0f', minHeight: '100vh' }}>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(partJsonLd) }} />
      <style>{`
