        ...
        <div className="pdp-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 360px', gap: '32px', alignItems: 'start' }}>
          ...
          <div>
            ...
            <div style={{ position: 'relative', background: '#1a1b1f', borderRadius: '16px', height: '320px', marginBottom: '24px', border: '1px solid #252629', overflow: 'hidden' }}>
              ...
              />
              {inStock && (
                <div style={{ position: 'absolute', top: 12, left: 12, background: 'rgba(34,197,94,0.15)', border: '1px solid rgba(34,197,94,0.3)', color: '#22c55e', padding: '4px 10px', borderRadius: '6px', fontSize: '12px', fontWeight: 600, backdropFilter: 'blur(4px)' }}>
                  Na stanju
                </div>
              )}
            </div>
          ...
          {/* Right: Buy card */}
          <div className="pdp-sticky" style={{ position: 'sticky', top: '80px' }}>
              ...
              {related.map((rp) => {
                ...
                return (
                  <Link key={rp.id} href={`/parts/${rp.slug || rp.id}`} style={{ textDecoration: 'none' }}>
                    <div style={{ background: '#1a1b1f', borderRadius: '12px', overflow: 'hidden', border: '1px solid #252629', transition: 'border-color 0.2s' }}>
                      <div style={{ position: 'relative', background: '#252629', height: '120px', overflow: 'hidden' }}>
                        ...
                        />
                        {rpInStock && (
                          <div style={{ position: 'absolute', top: 8, right: 8, background: 'rgba(12,13,15,0.85)', color: '#22c55e', padding: '3px 6px', borderRadius: '4px', fontSize: '10px', fontWeight: 600 }}>Na stanju</div>
                        )}
                      </div>
                      <div style={{ padding: '12px' }}>
                        ...
                        <p style={{ color: '#ff4d00', fontSize: '16px', fontWeight: 700 }}>{rp.price.toLocaleString('sr-RS')} RSD</p>
                      </div>
                    </div>
                  </Link>
                );
