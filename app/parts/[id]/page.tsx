    ...
    <div style={{ background: '#0c0d0f', minHeight: '100vh' }}>
      ...
      <style>{`
        @media (max-width: 768px) {
          ...
          .part-breadcrumb { font-size: 12px !important; }
        }
      `}</style>
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '24px 16px' }}>
        {/* Breadcrumb */}
        <div className="part-breadcrumb" style={{ display: 'flex', gap: '8px', alignItems: 'center', marginBottom: '24px', fontSize: '14px', flexWrap: 'wrap' }}>
          ...
          <div className="part-buy-card" style={{ position: 'sticky', top: '80px' }}>
            <div style={{ background: '#1a1b1f', borderRadius: '16px', padding: '24px', border: '1px solid #252629' }}>
              ...
              <Link
                ...
                style={{ display: 'block', width: '100%', padding: '12px', marginTop: '10px', background: '#252629', borderRadius: '10px', color: '#fff', fontSize: '14px', fontWeight: 600, textAlign: 'center', textDecoration: 'none', boxSizing: 'border-box' as const }}
              >
                ≈ Uporedi
              </Link>
              {part.supplier && (
