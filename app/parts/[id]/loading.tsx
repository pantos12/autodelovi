    ...
    <div style={{ background: '#0c0d0f', minHeight: '100vh' }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '24px 16px' }}>
        ...
        <div className="part-detail-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 360px', gap: '32px', alignItems: 'start' }}>
          <div>
            {/* Image skeleton */}
            <div style={{ background: 'linear-gradient(90deg, #1a1b1f 25%, #252629 50%, #1a1b1f 75%)', backgroundSize: '200% 100%', borderRadius: '16px', height: '320px', marginBottom: '24px', animation: 'shimmer 1.5s infinite' }} />
            {/* Title skeleton */}
            <div style={{ height: '28px', width: '70%', background: '#252629', borderRadius: '6px', marginBottom: '12px' }} />
            ...
            <div style={{ background: '#1a1b1f', borderRadius: '12px', overflow: 'hidden', border: '1px solid #252629' }}>
              {Array.from({ length: 6 }).map((_, i) => (
                <div key={i} style={{ display: 'flex', justifyContent: 'space-between', padding: '12px 20px', borderBottom: '1px solid #252629' }}>
                  <div style={{ height: '14px', width: '80px', background: '#252629', borderRadius: '4px' }} />
                  <div style={{ height: '14px', width: '120px', background: '#252629', borderRadius: '4px' }} />
                </div>
              ))}
