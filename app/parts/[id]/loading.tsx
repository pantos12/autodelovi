  ...
  return (
    <div style={{ background: '#0c0d0f', minHeight: '100vh' }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '24px 16px' }}>
        <div style={{ height: '16px', width: '300px', background: '#252629', borderRadius: '6px', marginBottom: '24px' }} />
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 360px', gap: '32px' }}>
          <div>
            ...
            <div style={{ height: '28px', width: '60%', background: '#252629', borderRadius: '8px', marginBottom: '12px' }} />
            <div style={{ height: '16px', width: '40%', background: '#252629', borderRadius: '6px', marginBottom: '24px' }} />
