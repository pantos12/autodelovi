  ...
  return (
    <div style={{ background: '#0c0d0f', minHeight: '100vh' }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '24px 16px' }}>
        <div style={{ height: '14px', width: '300px', background: '#1a1b1f', borderRadius: '4px', marginBottom: '24px' }} />
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 360px', gap: '32px' }}>
          <div>
            ...
            <div style={{ height: '28px', width: '60%', background: '#1a1b1f', borderRadius: '4px', marginBottom: '12px' }} />
          ...
          <div style={{ background: '#1a1b1f', borderRadius: '16px', height: '340px' }} />
        </div>
      </div>
    </div>
  );
