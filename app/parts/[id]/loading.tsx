    ...
    <div style={{ background: '#0c0d0f', minHeight: '100vh' }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '24px 16px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 360px', gap: '32px' }}>
          <div>
            <div style={{ background: '#1a1b1f', borderRadius: '16px', height: '320px', marginBottom: '24px', animation: 'shimmer 1.5s infinite' }} />
            <div style={{ height: '32px', background: '#1a1b1f', borderRadius: '8px', width: '60%', marginBottom: '12px' }} />
            <div style={{ height: '20px', background: '#1a1b1f', borderRadius: '8px', width: '40%', marginBottom: '24px' }} />
