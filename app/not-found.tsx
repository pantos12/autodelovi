...
export default function NotFound() {
  return (
    <div style={{ background: '#0c0d0f', minHeight: 'calc(100vh - 136px)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', gap: '16px', padding: '24px', textAlign: 'center' }}>
