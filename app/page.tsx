...
export const metadata: Metadata = {
  ...
  description: 'Agregiramo 50,000+ auto delova od 200+ proverenih dobavljača širom Srbije. Pretražite po vozilu, broju dela ili brendu.',
  keywords: ['auto delovi', 'Srbija', 'marketplace', 'delovi za automobile', 'OEM', 'aftermarket'],
};
  ...
  return (
    <>
      <style>{`
        ...
        .cat-card:hover { border-color: rgba(249,55,44,0.4) !important; }
      `}</style>
        ...
        <section className="section-pad" style={{ position: 'relative', zIndex: 5, maxWidth: '900px', margin: '0 auto', padding: '0 24px 80px' }}>
          ...
          <div className="categories-grid" style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr', gap: '12px' }}>
            {[
              ...
              <Link href={'/categories/' + cat.slug} key={cat.slug} style={{ textDecoration: 'none', color: 'inherit' }}>
                <div className="cat-card" style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '12px', padding: cat.large ? '28px' : '24px', cursor: 'pointer', height: '100%', transition: 'border-color 0.2s' }}>
