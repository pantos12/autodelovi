...
export const metadata: Metadata = {
  ...
  description: 'Agregiramo skladište od 50,000+ auto delova od 200+ proverenih dobavljača širom Srbije. Pronađite delove za VW, BMW, Mercedes, Audi, Opel i još mnogo.',
};
