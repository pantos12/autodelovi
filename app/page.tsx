...
export const metadata: Metadata = {
  ...
  description: 'Agregiramo 50,000+ auto delova od 200+ proverenih dobavljaca sirom Srbije. Pretrazite po marki, modelu ili broju dela. VW, BMW, Mercedes, Audi, Opel i jos mnogo.',
